"""Source: http://jorisvr.nl/article/maximum-matching
...
def maxWeightMatching(edges, maxcardinality=False, CHECK_DELTA=False, CHECK_OPTIMUM=False):
    ...
    if sys_version < '3':
        ...
        sys_exit('Python version is too old.')
    else:
        integer_types = (int,)
            ...
            if label[inblossom[v]] == 0:
                ...
                if DEBUG and (bestedge[v] != -1 or bk != -1) and (bestedge[v] == -1 or bd != slack(bestedge[v])):
                    DEBUG('v=' + str(v) + ' bk=' + str(bk) + ' bd=' + str(bd) +
                          ' bestedge=' + str(bestedge[v]) + ' slack=' + str(slack(bestedge[v])))
                assert (
                    bk == -1 and bestedge[v] == -1) or (bestedge[v] != -1 and bd == slack(bestedge[v]))
        ...
        for b in range(2 * nvertex):
            if blossomparent[b] == -1 and label[b] == 1:
                ...
                if bestedge[b] != -1:
                    ...
                    assert inblossom[i] != b or inblossom[j] != b
                    assert label[inblossom[i]
                                 ] == 1 and label[inblossom[j]] == 1
...
if __name__ == '__main__':
    ...
    class MaxWeightMatchingTests(unittest.TestCase):
        ...
        def test32_t_expand_leastslack(self):
            ...
            self.assertEqual(maxWeightMatching([(1, 2, 45), (1, 5, 45), (2, 3, 50), (3, 4, 45), (4, 5, 50), (
                1, 6, 30), (3, 9, 35), (4, 8, 28), (5, 7, 26), (9, 10, 5)]), [-1, 6, 3, 2, 8, 7, 1, 5, 4, 10, 9])
        ...
        def test33_nest_tnasty_expand(self):
            ...
            self.assertEqual(maxWeightMatching([(1, 2, 45), (1, 7, 45), (2, 3, 50), (3, 4, 45), (4, 5, 95), (4, 6, 94), (5, 6, 94), (
                6, 7, 50), (1, 8, 30), (3, 11, 35), (5, 9, 36), (7, 10, 26), (11, 12, 5)]), [-1, 8, 3, 2, 6, 9, 4, 10, 1, 5, 7, 12, 11])
        ...
        def test34_nest_relabel_expand(self):
            ...
            self.assertEqual(maxWeightMatching([(1, 2, 40), (1, 3, 40), (2, 3, 60), (2, 4, 55), (3, 5, 55), (4, 5, 50), (
                1, 8, 15), (5, 7, 30), (7, 6, 10), (8, 10, 10), (4, 9, 30)]), [-1, 2, 1, 5, 9, 3, 7, 6, 10, 4, 8])
